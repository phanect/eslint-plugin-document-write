...
module.exports = {
  ...
  create(context) {
    return {
      "CallExpression > MemberExpression.callee[object.name = 'document'][property.name = 'write'],CallExpression > MemberExpression.callee[object.name = 'document'][property.name = 'writeln']"(node) {
        context.report({
          node: node.parent,
